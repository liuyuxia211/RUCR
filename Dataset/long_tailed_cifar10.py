...
def train_long_tail(list_label2indices_train, num_classes, imb_factor, imb_type):
    new_list_label2indices_train = label_indices2indices(list_label2indices_train)
    img_num_list = _get_img_num_per_cls(new_list_label2indices_train, num_classes, imb_factor, imb_type)
    ...
    return img_num_list, num_list_clients_indices, list_clients_indices
